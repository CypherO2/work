        ...
        <div className="px-5">
          <MDBRow className="my-2">
            <MDBCol>
              ...
              <h5 className="">
                Welcome to my first blog, as a bit of an explaination as to why
                I started this: I was bored.Anyways! My name is CJ, you can call
                me that or by my online psuedonym 'Cassi', I am a chronically
                ...
                bot Sgathach, whom was named for the trainer of "the Hound of
                Ireland: Cu Chulainn"!
                <br />
                <br />
          ...
          <MDBRow className="my-2">
            <MDBCol>
              ...
              <h5 className="">
                ...
                was enamoured with art, at first it was something I did to prove
                I was as good as others, a product of my insecurities after
                moving schools. I continued to draw and create differenct pieces
                ...
                school) when Covid-19 hit in Spring of that year.
                <br />
                <br />
                Throughout Covid-19 I had a benefit that no other student had;
                my mother was a key worker - an adult social care worker -
                meaning I was kept in school during the lockdown, where me and
                my siblings spent everyday for the period of time that was the
                lockdown. During this time, I practices and taught myself may
                different techniques and began that process of choosing my
                elective for my last 2 years.
                <br />
          ...
          <MDBRow className="my-2">
            <MDBCol>
              ...
              <h5 className="">
                ...
                work with databases and development enviroments at this people
                ...
                specifically - OOP in .NET form applicationsthrough Visual
          ...
          <MDBRow className="my-2">
            <MDBCol>
              ...
              <h5 className="">
                ...
                Lethal Company with other and streamign them for the world to
                see, I also enjoy posting creating, editing and producing video
                for online platforms like YouTube.
                <br />
                <br />
                ...
                group helping to manage magazine creation, joining in on project
                and events, and helping with the planning and/or function of
                events.
              </h5>
            </MDBCol>
          </MDBRow>
          <MDBRow className="my-2">
            <MDBCol>
              ...
              <h5 className="">
                ...
                promotional/ accompanying video essays and blogs on anything
                from art to code and anything else that catches my interest.
              </h5>
            </MDBCol>
          </MDBRow>
          <MDBRow className="my-2">
